...
typedef TMilli NodoAnclaC__Timer_Localizacion__precision_tag;
typedef TMilli NodoAnclaC__Timer_Cambio_Canal__precision_tag;
...
static void NodoAnclaC__CC2420Config__syncDone(error_t error);
# 113 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void NodoAnclaC__AMControl__startDone(error_t error);
#line 138
static void NodoAnclaC__AMControl__stopDone(error_t error);
# 60 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void NodoAnclaC__Boot__booted(void );
# 83 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void NodoAnclaC__Timer_Localizacion__fired(void );
#line 83
static void NodoAnclaC__Timer_Cambio_Canal__fired(void );
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void NodoAnclaC__AMSend__sendDone(
#line 103
message_t * msg, 
...
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
static void NodoAnclaC__CC2420Config__setChannel(uint8_t channel);
#line 52
static error_t NodoAnclaC__CC2420Config__sync(void );
# 104 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t NodoAnclaC__AMControl__start(void );
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void NodoAnclaC__Timer_Localizacion__startPeriodic(uint32_t dt);
#line 78
static void NodoAnclaC__Timer_Localizacion__stop(void );
# 126 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static 
#line 123
void * 
...
NodoAnclaC__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static bool NodoAnclaC__Timer_Cambio_Canal__isRunning(void );
#line 64
static void NodoAnclaC__Timer_Cambio_Canal__startPeriodic(uint32_t dt);
#line 78
static void NodoAnclaC__Timer_Cambio_Canal__stop(void );
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t NodoAnclaC__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static int8_t NodoAnclaC__CC2420Packet__getRssi(message_t *p_msg);
# 61 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void NodoAnclaC__Leds__led0Off(void );
...
static void NodoAnclaC__Leds__led1On(void );




static void NodoAnclaC__Leds__led1Off(void );
#line 94
static void NodoAnclaC__Leds__led2Off(void );
#line 56
static void NodoAnclaC__Leds__led0On(void );
#line 89
static void NodoAnclaC__Leds__led2On(void );
# 88 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t NodoAnclaC__AMPacket__source(
#line 84
message_t * amsg);
# 21 "NodoAnclaC.nc"
static inline int16_t NodoAnclaC__getRssi(message_t *msg);

static inline void NodoAnclaC__receive_Cambio_Canal_Msg(message_t *msg, void *payload);


message_t NodoAnclaC__pkt;
bool NodoAnclaC__busy = FALSE;

uint16_t NodoAnclaC__turno = 0;

uint8_t NodoAnclaC__rssi;
int16_t NodoAnclaC__rssi2;

uint16_t NodoAnclaC__orden_TDMA_ancla[NUM_NODO_ANCLA] = { 0, 0, 0, 0 };

uint16_t NodoAnclaC__ID_ack_cambio_canal[NUM_NODO_ANCLA] = { 0, 0, 0, 0 };

uint8_t NodoAnclaC__canal_deseado;

bool NodoAnclaC__send_cambio_canal = FALSE;

static void NodoAnclaC__setLeds(uint16_t val);
#line 60
static inline void NodoAnclaC__Boot__booted(void );





static inline void NodoAnclaC__AMControl__startDone(error_t err);
...
static inline void NodoAnclaC__AMControl__stopDone(error_t err);


static inline void NodoAnclaC__CC2420Config__syncDone(error_t error);
#line 92
static inline void NodoAnclaC__Timer_Localizacion__fired(void );
#line 118
static inline void NodoAnclaC__Timer_Cambio_Canal__fired(void );
#line 174
static inline void NodoAnclaC__AMSend__sendDone(message_t *msg, error_t err);
...
static inline message_t *NodoAnclaC__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 205
static inline int16_t NodoAnclaC__getRssi(message_t *msg);
#line 217
static inline void NodoAnclaC__receive_Cambio_Canal_Msg(message_t *msg, void *payload);
...
message_t *msg);
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static error_t /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 120 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40f05728){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40f05728) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40f05728);
#line 120
      break;
#line 120
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x41222df8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x41222df8, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40f05728){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40f05728);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40f031b8){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40f031b8);
#line 39
...
# 97 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40f05728){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40f05728);
#line 97
      break;
#line 97
    }
...
# 88 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40f05728){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40f05728);
#line 88
      break;
#line 88
    }
...
#line 174
{
  if (&NodoAnclaC__pkt == msg) {
      NodoAnclaC__busy = FALSE;
    }
}

# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  NodoAnclaC__AMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
#line 100
    case 0U:
#line 100
      /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41222780, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41222780, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x41222df8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x41222df8, msg);
#line 95
}
#line 95
...
# 102 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x411ebd50){
#line 102
  switch (arg_0x411ebd50) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x411ebd50);
#line 102
      break;
#line 102
    }
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x41224da0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x41224da0, msg, payload, len);
#line 78
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static bool NodoAnclaC__Timer_Cambio_Canal__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void NodoAnclaC__Timer_Cambio_Canal__startPeriodic(uint32_t dt){
#line 64
...
# 88 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_addr_t NodoAnclaC__AMPacket__source(message_t * amsg){
#line 88
  unsigned int __nesc_result;
#line 88
...
#line 217
{
  ...
  if (NodoAnclaC__AMPacket__source(msg) == ID_MAESTRO) {
      NodoAnclaC__canal_deseado = __nesc_ntoh_uint8(men_revc->canal.data);
      NodoAnclaC__Timer_Cambio_Canal__startPeriodic(TIMER_SLOT_CHANGE_CHANNEL);
    }

  if (NodoAnclaC__Timer_Cambio_Canal__isRunning()) {

      for (i = 0; i < NUM_NODO_ANCLA; i++) {
          if (__nesc_ntoh_uint16(men_revc->nodeid.data) == NodoAnclaC__ID_ack_cambio_canal[i]) {
              break;
            }
          else {
#line 231
            if (NodoAnclaC__ID_ack_cambio_canal[i] == 0) {
                printf(" nodeid canal %u\n", __nesc_ntoh_uint16(men_revc->nodeid.data));
                printfflush();
                NodoAnclaC__ID_ack_cambio_canal[i] = __nesc_ntoh_uint16(men_revc->nodeid.data);
                break;
              }
            }
        }
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void NodoAnclaC__Timer_Localizacion__startPeriodic(uint32_t dt){
#line 64
...
# 64 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static int8_t NodoAnclaC__CC2420Packet__getRssi(message_t *p_msg){
#line 64
...
#line 205
{
  NodoAnclaC__rssi = NodoAnclaC__CC2420Packet__getRssi(msg);
  if (NodoAnclaC__rssi >= 128) {
      NodoAnclaC__rssi2 = NodoAnclaC__rssi - 45 - 256;
    }
  else {
      NodoAnclaC__rssi2 = NodoAnclaC__rssi - 45;
    }

  return NodoAnclaC__rssi2;
}
...
#line 184
  NodoAnclaC__setLeds(0x01);
  if (len == sizeof(TMDA_Localizacion_Msg )) {
      TMDA_Localizacion_Msg *men_revc = (TMDA_Localizacion_Msg *)payload;

#line 187
      NodoAnclaC__getRssi(msg);
      for (i = 0; i < NUM_NODO_ANCLA; i++) {
          NodoAnclaC__orden_TDMA_ancla[i] = __nesc_ntoh_uint16(men_revc->orden_TDMA[i].data);
        }

      if (NodoAnclaC__turno >= NUM_NODO_ANCLA) {
          NodoAnclaC__turno = 0;
        }

      NodoAnclaC__Timer_Localizacion__startPeriodic(TIMER_PERIOD_MILLI_ANCLA);
    }
  if (len == sizeof(Cambio_Canal_Msg )) {
      NodoAnclaC__receive_Cambio_Canal_Msg(msg, payload);
    }
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x41224708, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x41224708) {
#line 78
    case 26:
#line 78
      __nesc_result = NodoAnclaC__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x41224708, msg, payload, len);
#line 78
      break;
#line 78
    }
...
inline static void NodoAnclaC__Leds__led0On(void ){
#line 56
  LedsP__Leds__led0On();
#line 56
}
...
# 61 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void NodoAnclaC__Leds__led0Off(void ){
#line 61
...
inline static void NodoAnclaC__Leds__led1On(void ){
#line 72
  LedsP__Leds__led1On();
#line 72
}
...
inline static void NodoAnclaC__Leds__led1Off(void ){
#line 77
...
inline static void NodoAnclaC__Leds__led2On(void ){
#line 89
  LedsP__Leds__led2On();
#line 89
}
...
inline static void NodoAnclaC__Leds__led2Off(void ){
#line 94
...
# 102 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40f07368){
#line 102
  switch (arg_0x40f07368) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40f07368);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40f06f18, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40f06f18) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40f06f18, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40e96010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40e96010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40e96010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x41222df8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x41222df8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40e96010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40e96010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40e96010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 59 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static void NodoAnclaC__CC2420Config__setChannel(uint8_t channel){
#line 59
...
#line 78
{
  ...
  if (error == SUCCESS) 
  ...
  else 
    {
      ...
      NodoAnclaC__CC2420Config__setChannel(NodoAnclaC__canal_deseado);
    }
}
...
#line 53
  NodoAnclaC__CC2420Config__syncDone(error);
#line 53
}
#line 53
...
#line 100
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41227ca0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41227ca0, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 138
  NodoAnclaC__AMControl__stopDone(error);
#line 138
}
#line 138
...
# 104 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t NodoAnclaC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 113
  NodoAnclaC__AMControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 78 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void NodoAnclaC__Timer_Localizacion__stop(void ){
#line 78
...
#line 78
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t NodoAnclaC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * NodoAnclaC__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 92
{
  ...
  if (NodoAnclaC__orden_TDMA_ancla[NodoAnclaC__turno] == TOS_NODE_ID && !NodoAnclaC__busy) {

      Ancla_Localizacion_Msg *men_send = (Ancla_Localizacion_Msg *)NodoAnclaC__Packet__getPayload(&NodoAnclaC__pkt, sizeof(Ancla_Localizacion_Msg ));

#line 97
      NodoAnclaC__setLeds(0x02);
      ...
      __nesc_hton_int16(men_send->rssi.data, NodoAnclaC__rssi2);

      if (NodoAnclaC__AMSend__send(AM_BROADCAST_ADDR, &NodoAnclaC__pkt, sizeof(Ancla_Localizacion_Msg )) == SUCCESS) {
          NodoAnclaC__busy = TRUE;
        }
    }

  if (NodoAnclaC__turno >= NUM_NODO_ANCLA) {
      NodoAnclaC__Timer_Localizacion__stop();
    }

  NodoAnclaC__turno = NodoAnclaC__turno + 1;
}

# 78 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void NodoAnclaC__Timer_Cambio_Canal__stop(void ){
#line 78
...
inline static error_t NodoAnclaC__CC2420Config__sync(void ){
#line 52
  unsigned char __nesc_result;
#line 52
...
#line 118
{
  Cambio_Canal_Msg *men_send = (Cambio_Canal_Msg *)NodoAnclaC__Packet__getPayload(&NodoAnclaC__pkt, sizeof(Cambio_Canal_Msg ));
  int i = 0;
  bool cambio_canal = TRUE;

  if (NodoAnclaC__orden_TDMA_ancla[NodoAnclaC__turno] == TOS_NODE_ID && !NodoAnclaC__busy) {
      NodoAnclaC__setLeds(7);
      for (i = 0; i < NUM_NODO_ANCLA; i++) 
        {
          if (NodoAnclaC__ID_ack_cambio_canal[i] == 0) {
              cambio_canal = FALSE;
      ...
      if (cambio_canal == TRUE && NodoAnclaC__send_cambio_canal == TRUE) {
          NodoAnclaC__setLeds(0);

          for (i = 0; i < NUM_NODO_ANCLA; i++) 
            {
              NodoAnclaC__ID_ack_cambio_canal[i] = 0;
            }
          __nesc_hton_uint16(men_send->nodeid.data, TOS_NODE_ID);
          __nesc_hton_uint8(men_send->canal.data, NodoAnclaC__canal_deseado);
          printf("Enviado mensaje cambio de canal\n");
          printfflush();

          if (
#line 143
          NodoAnclaC__AMSend__send(AM_BROADCAST_ADDR, 
          &NodoAnclaC__pkt, sizeof(Cambio_Canal_Msg )) == SUCCESS) {
              NodoAnclaC__busy = TRUE;
            }
          NodoAnclaC__CC2420Config__setChannel(NodoAnclaC__canal_deseado);
          NodoAnclaC__CC2420Config__sync();
          NodoAnclaC__send_cambio_canal = FALSE;


          NodoAnclaC__Timer_Cambio_Canal__stop();
        }
      else {
          __nesc_hton_uint16(men_send->nodeid.data, TOS_NODE_ID);
          __nesc_hton_uint8(men_send->canal.data, NodoAnclaC__canal_deseado);
...
#line 159
          ...
          NodoAnclaC__send_cambio_canal = TRUE;
        }
    }
  NodoAnclaC__turno = NodoAnclaC__turno + 1;
...
#line 83
    case 0U:
#line 83
      NodoAnclaC__Timer_Localizacion__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      NodoAnclaC__Timer_Cambio_Canal__fired();
#line 83
      break;
#line 83
    default:
...
# 103 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
# 162 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 60
{
  ...
  NodoAnclaC__AMControl__start();
  NodoAnclaC__setLeds(4);
}

# 60 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
inline static void PrintfP__Boot__booted(void ){
#line 60
  NodoAnclaC__Boot__booted();
#line 60
}
#line 60
...
{
  if (val & 0x01) {
    NodoAnclaC__Leds__led0On();
    }
  else {
#line 46
    NodoAnclaC__Leds__led0Off();
    }
#line 47
  if (val & 0x02) {
    NodoAnclaC__Leds__led1On();
    }
  else {
#line 50
    NodoAnclaC__Leds__led1Off();
    }
#line 51
  if (val & 0x04) {
    NodoAnclaC__Leds__led2On();
    }
  else {
#line 54
    NodoAnclaC__Leds__led2Off();
    }
}
...
#line 55
{
  /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 26);
  return /*NodoAnclaAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
