...
typedef TMilli EsclavoC__Timer_Ubicacion__precision_tag;
...
static void EsclavoC__Timer_Ubicacion__fired(void );
# 113 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
...
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void EsclavoC__Timer_Ubicacion__startPeriodic(uint32_t dt);
#line 78
static void EsclavoC__Timer_Ubicacion__stop(void );
# 104 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
...
# 19 "EsclavoC.nc"
static inline void EsclavoC__receive_Datos(message_t *msg, void *payload);

static inline void EsclavoC__receive_TMDA_Ubicacion(message_t *msg, void *payload);


static void EsclavoC__printfFloat(float floatToBePrinted);


static inline void EsclavoC__calculatePosition(void );


static int16_t EsclavoC__getRssi(message_t *msg);


static inline void EsclavoC__receiveAncla_Localizacion(message_t *msg, void *payload);


static inline float EsclavoC__median(int lenght, float x[]);
...
uint16_t EsclavoC__turno = 0;

uint8_t EsclavoC__rssi;
int16_t EsclavoC__rssi2;

uint16_t EsclavoC__orden_TDMA_ancla[NUM_NODO_ANCLA] = { ID_ANCLA_1, ID_ANCLA_2, ID_ANCLA_3, ID_ANCLA_4 };

float EsclavoC__POS_NODOS_X[NUM_NODO_ANCLA] = { X_1, X_2, X_3, X_4 };
float EsclavoC__POS_NODOS_Y[NUM_NODO_ANCLA] = { Y_1, Y_2, Y_3, Y_4 };

float EsclavoC__distancia_nodos[NUM_NODO_ANCLA] = { 0, 0, 0, 0 };
float EsclavoC__distancia_nodos_muestas[NUM_NODO_ANCLA][MUESTRAS];
float EsclavoC__posicion[NUM_COORDENADAS] = { 0, 0 };

uint8_t EsclavoC__num_muestras = MUESTRAS - 1;

uint16_t EsclavoC__orden_TDMA_esclavos[NUM_NODO_ESCLAVO] = { 0 };



static void EsclavoC__setLeds(uint16_t val);
#line 79
...
static inline void EsclavoC__Timer_Ubicacion__fired(void );
#line 110
...
message_t *msg);
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static error_t /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 120 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40ef7728){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40ef7728) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40ef7728);
#line 120
      break;
#line 120
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x41257df8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x41257df8, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40ef7728){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40ef7728);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40ef61b8){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40ef61b8);
#line 39
...
# 97 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40ef7728){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40ef7728);
#line 97
      break;
#line 97
    }
...
# 88 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40ef7728){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40ef7728);
#line 88
      break;
#line 88
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
...
#line 65
{
  /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
#line 100
    case 0U:
#line 100
      /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41257780, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41257780, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x41257df8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x41257df8, msg);
#line 95
}
#line 95
...
#line 80
  __nesc_result = /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
#line 213
{
  ...
  Datos *men_send = (Datos *)EsclavoC__Packet__getPayload(&EsclavoC__pkt, sizeof(Datos ));

#line 217
  __nesc_hton_uint16(men_send->datos.data, TOS_NODE_ID * 100);

  if (
#line 218
  EsclavoC__AMSend__send(ID_MAESTRO, 
  &EsclavoC__pkt, sizeof(Datos )) == SUCCESS) {
      EsclavoC__busy = TRUE;
    }
}
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void EsclavoC__Timer_Ubicacion__startPeriodic(uint32_t dt){
#line 64
...
#line 224
{
  ...
  for (i = 0; i < NUM_NODO_ANCLA; i++) {
      ...
      EsclavoC__orden_TDMA_esclavos[i] = __nesc_ntoh_uint16(men_revc->orden_TDMA[i].data);
    }

  EsclavoC__turno = 0;

  EsclavoC__Timer_Ubicacion__startPeriodic(TIMER_PERIOD_MILLI_UBICACION_ESCLAVO);
}
...
#line 264
{
  ...
  for (i = 0; i < NUM_NODO_ANCLA; i = i + 1) {
      float wij = 1 / powf(EsclavoC__distancia_nodos[i], p);

#line 276
      EsclavoC__distancia_nodos[i] = 0;
      sumwij = sumwij + wij;

      sumMultiX = sumMultiX + wij * EsclavoC__POS_NODOS_X[i];
      sumMultiY = sumMultiY + wij * EsclavoC__POS_NODOS_Y[i];
    }


  EsclavoC__posicion[0] = sumMultiX / sumwij;

  EsclavoC__posicion[1] = sumMultiY / sumwij;

  printf("Posicion: (");
  EsclavoC__printfFloat(EsclavoC__posicion[0]);
  printf(",");
  EsclavoC__printfFloat(EsclavoC__posicion[1]);
  printf(")\n");
  printfflush();


  EsclavoC__num_muestras = MUESTRAS - 1;
}
...
#line 152
{
  ...
  int16_t rssiMedido = (float )EsclavoC__getRssi(msg);
  ...
  for (i = 0; i < NUM_NODO_ANCLA; i = i + 1) {
      ...
      if (__nesc_ntoh_uint16(men_revc->nodeid.data) == EsclavoC__orden_TDMA_ancla[i]) {


          EsclavoC__distancia_nodos_muestas[i][EsclavoC__num_muestras] = distancia;
        }
    }

  EsclavoC__setLeds(0x01);

  if (EsclavoC__orden_TDMA_ancla[NUM_NODO_ANCLA - 1] == __nesc_ntoh_uint16(men_revc->nodeid.data)) {
      printf("tdma");
      printfflush();
      EsclavoC__setLeds(0x04);

      if (EsclavoC__num_muestras <= 0) {
          printf("1");
          printfflush();
          for (i = 0; i < NUM_NODO_ANCLA; i = i + 1) {

              EsclavoC__distancia_nodos[i] = EsclavoC__median(MUESTRAS, EsclavoC__distancia_nodos_muestas[i]);
            }

          printf("1");
          EsclavoC__printfFloat(EsclavoC__distancia_nodos[0]);

          printfflush();
          printf("2");
          EsclavoC__printfFloat(EsclavoC__distancia_nodos[1]);
          printfflush();
          printf("3");
          EsclavoC__printfFloat(EsclavoC__distancia_nodos[2]);
          printfflush();
          printf("4");
          EsclavoC__printfFloat(EsclavoC__distancia_nodos[3]);
          printfflush();
          ...
          if (
#line 202
          EsclavoC__distancia_nodos[0] != 0 && EsclavoC__distancia_nodos[1] != 0
           && EsclavoC__distancia_nodos[2] != 0 && EsclavoC__distancia_nodos[3] != 0) {

              EsclavoC__calculatePosition();
            }
        }
      else 
#line 207
        {
          EsclavoC__num_muestras--;
        }
    }
}
...
#line 129
{
  ...
  if (len == sizeof(Ancla_Localizacion_Msg )) {
      ...
      EsclavoC__receiveAncla_Localizacion(msg, payload);
    }
  if (len == sizeof(TMDA_Ubicacion_Msg )) {

      EsclavoC__receive_TMDA_Ubicacion(msg, payload);
    }
  ...
  if (len == sizeof(Datos )) {
      ...
      EsclavoC__receive_Datos(msg, payload);
    }
...
# 103 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
# 162 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 102 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40efa368){
#line 102
  switch (arg_0x40efa368) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40efa368);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40ef8f18, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40ef8f18) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40ef8f18, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40e89010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40e89010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40e89010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x41257df8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x41257df8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40e89010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40e89010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40e89010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40e8a558){
#line 102
  switch (arg_0x40e8a558) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x40e8a558);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x4121aca0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x4121aca0, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 267 "/opt/tinyos-2.x/tos/chips/msp430/msp430hardware.h"
static __inline  float __nesc_hton_afloat(void * target, float value)
#line 267
{
...
# 78 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void EsclavoC__Timer_Ubicacion__stop(void ){
#line 78
...
#line 84
{
  if (EsclavoC__orden_TDMA_esclavos[EsclavoC__turno] == TOS_NODE_ID && !EsclavoC__busy) {

      TMDA_Ubicacion_Esclavo_Msg *men_send = (TMDA_Ubicacion_Esclavo_Msg *)EsclavoC__Packet__getPayload(&EsclavoC__pkt, sizeof(TMDA_Ubicacion_Esclavo_Msg ));

      EsclavoC__setLeds(0x07);

      __nesc_hton_uint16(men_send->nodeid.data, TOS_NODE_ID);
      __nesc_hton_afloat(men_send->x.data, EsclavoC__posicion[0]);
      __nesc_hton_afloat(men_send->y.data, EsclavoC__posicion[1]);


      if (
#line 95
      EsclavoC__AMSend__send(ID_MAESTRO, 
      &EsclavoC__pkt, sizeof(TMDA_Ubicacion_Esclavo_Msg )) == SUCCESS) {

          EsclavoC__busy = TRUE;
        }
    }

  if (EsclavoC__turno >= NUM_NODO_ESCLAVO) {

      EsclavoC__Timer_Ubicacion__stop();
    }

  EsclavoC__turno = EsclavoC__turno + 1;
}
...
# 83 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40c62030){
#line 83
  switch (arg_0x40c62030) {
#line 83
    case 0U:
#line 83
      EsclavoC__Timer_Ubicacion__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40c62030);
#line 83
      break;
#line 83
    }
...
#line 300
{
  EsclavoC__rssi = EsclavoC__CC2420Packet__getRssi(msg);

  if (EsclavoC__rssi >= 128) {

      EsclavoC__rssi2 = EsclavoC__rssi - 45 - 256;
    }
  else {

      EsclavoC__rssi2 = EsclavoC__rssi - 45;
    }

  return EsclavoC__rssi2;
}
...
#line 55
{
  /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 26);
  return /*EsclavoAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
